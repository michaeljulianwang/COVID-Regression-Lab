...
Our initial EDA shows a strong, linear relationship between our SAH order length and the dependent variable (Figure 2).  
...
In Figure 4, we observe the distribution of our dependent variable does appear to exhibit a slightly heavier left tail than a normal distribution as a result of a few states having far lower reductions in R&R mobility than other states  
