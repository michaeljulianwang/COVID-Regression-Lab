...
mobility <- read.csv('../data/raw/2020_US_Region_Mobility_Report.csv',
                     stringsAsFactors = F)
stateInfo <- read.xlsx('COVID-19 US state policy database 3_17_2021.xlsx',
...
COVIDData <- read.csv('United_States_COVID-19_Cases_and_Deaths_by_State_over_Time.csv', stringsAsFactors = F) 
